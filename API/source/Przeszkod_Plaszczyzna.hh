...
class Przeszkoda_Plaszczyzna : public Przeszkoda
{
...
virtual bool kolizja(Dron &dron)
{
  ...
  Przeszkoda_Plaszczyzna(double x, double y, double z,std::shared_ptr<drawNS::Draw3DAPI> &api):Przeszkoda( x,  y,  z,api)
  {}
};